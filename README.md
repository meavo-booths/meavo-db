...
| Sales | sales | Product, ProductFamilyInfo, Client* (incl. ClientLabel, ClientLabelAssignment, ClientEvent, ClientEventReceipt), Deal* (incl. DealSubscription), QuoteLineItem, BoothUnit, HubSpotLostReason, HubSpotDealSnapshot, QuotePdfTemplate, QuotePdfMarketDefault |

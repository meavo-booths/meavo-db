...
| Sales | sales | Product, ProductFamilyInfo, Client* (incl. ClientLabel, ClientLabelAssignment, ClientEvent, ClientEventReceipt), Deal* (incl. DealSubscription, DealLabel, DealLabelAssignment), QuoteLineItem, BoothUnit, HubSpotLostReason, HubSpotDealSnapshot, QuotePdfTemplate, QuotePdfMarketDefault |
